      ...
      >
        <div className="flex justify-center mb-4">
          <Button
            ...
            className="focus:outline-none text-xl z-50 px-2 py-2 max-sm:dark:bg-purple-400 dark:text-[#1a012d] bg-[#1a012d] text-purple-200 rounded-full transition-all duration-500 hover:scale-110"
          />
        </div>
