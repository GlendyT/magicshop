  ...
  return (
    <div className="text-white max-sm:text-xs w-96">
      <div className="px-10 rounded-2xl py-6 bg-black/30 backdrop-blur-lg">
        <div className="block mt-1 text-4xl text-center font-bold text-white max-md:text-2xl">
          Into the
          <div className="uppercase  font-thin text-5xl max-md:text-4xl">
            suga-verse
          </div>
          <h1 className="text-center text-sm pb-5 max-md:text-1xl">
      ...
      {error && (
        <p className="text-red-700 text-center font-bold upper case pt-1">
