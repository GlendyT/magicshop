...
export const sugaStyles: SugaStyle[] = [
  ...
  },
  {
    id: 2,
    name: "D-2",
    image: "/Sugaverse/d2.avif",
    style: [
      {
        div1: `${commonDiv1Styles} flex-col relative items-center`,
        div2: "flex flex-col absolute z-20 w-68 pl-14 text-white",
        div3: `${commonTextStyles}  text-center`,
        p: `${commonPStyles}  pt-6`,
      },
    ],
  },
  ...
  },
  {
    id: 4,
    name: "People Pt2",
    image: "/Sugaverse/pp2.avif",
    style: [
      {
        div1: `${commonDiv1Styles} flex-col relative items-center`,
        div2: " flex flex-col gap-10 w-56 absolute z-20 pb-20",
        div3: `${commonTextStyles} text-black text-center`,
  ...
  },
  {
    id: 5,
    name: "Haegum",
    image: "/Sugaverse/hgm.avif",
    style: [
      {
        div1: `${commonDiv1Styles}  flex-col relative items-center`,
        div2: "bg-orange-600 text-white w-full max-md:w-96 h-auto flex flex-col absolute z-20 px-8 py-2",
        div3: `${commonTextStyles}  bg-orange-600 `,
