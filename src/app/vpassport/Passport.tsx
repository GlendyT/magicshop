...
const Passport = () => {
  ...
  return (
    <div
      className={`shadow-md rounded-xl w-full h-full relative ${michroma.className}`}
    >
      <Image
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-start pt-14 justify-center">
        <div className=" flex flex-col pr-8 max-sm:pr-3 px-2">
          <span className={`flex text-center items-center justify-center font-extrabold pb-4 text-sm uppercase max-sm:pb-0 max-sm:text-[0.6rem] ${michroma.className}`}>
            Republic of ARMY
          </span>
          ...
          <div className="flex flex-col w-full items-center justify-center pt-4 max-lg:gap-2 max-sm:gap-0 text-[0.6rem] max-xl:text-[0.6rem] max-md:text-[0.5rem] max-sm:text-[0.3rem] max-lg:text-[0.7rem]">
            <span className="font-normal text-violet-950  flex flex-col ">
