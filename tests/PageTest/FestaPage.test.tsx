...
import Festa from "@/festa/page";
import useRequestInfo from "@/hooks/useRequestInfo";

jest.mock("../../src/app/festa/Formulario", () => () => <div>Formulario Component</div>);
jest.mock("../../src/app/festa/Resultado", () => () => <div>Resultado Component</div>);
jest.mock("@/hooks/useRequestInfo");

describe("Festa Component", () => {
